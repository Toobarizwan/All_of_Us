...
This guide is a guide on how to use `screen` to run jobs on All Of Us without keeping your laptop open. This will allow you to long jobs without interruption on a remote server. You can disconnect and reconnect from it.
